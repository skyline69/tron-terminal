// White stars flying toward you behind dark parts of the terminal.
// Ported to WGSL for tron from https://github.com/hackr-sh/ghostty-shaders/blob/main/starfield.glsl
