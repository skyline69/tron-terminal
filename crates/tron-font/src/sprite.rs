...
const LINES: [&str; 76] = [
    "0101", "0202", "1010", "2020", "0000", "0000", "0000", "0000", "0000", "0000", "0000", "0000",
...
const DOUBLE_LINES: [&str; 29] = [
    "0303", "3030", "0310", "0130", "0330", "0013", "0031", "0033", "1300", "3100", "3300", "1003",
    "3001", "3003", "1310", "3130", "3330", "1013", "3031", "3033", "0313", "0131", "0333", "1303",
...
impl Canvas {
    ...
    fn powerline(&mut self, cp: u32, light: i32) {
        ...
        match cp {
            ...
            0xE0B1 => self.sample(|x, y| {
                segment(x, y, 0.0, 0.0, w, mid) <= half || segment(x, y, w, mid, 0.0, h) <= half
            }),
            0xE0B3 => self.sample(|x, y| {
                segment(x, y, w, 0.0, 0.0, mid) <= half || segment(x, y, 0.0, mid, w, h) <= half
            }),
